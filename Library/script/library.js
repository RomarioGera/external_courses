...
// Loading Books on Page
var libraryArea = document.querySelector('.main-content');
var aBookArea = document.querySelector('.book-view');
...
function loadBooks() {
    ...
    for (var key in books) {
        bookBorder+= '<div class="book-view">' + bookContent + '</div>';

        bookContent+= '<div class="book-view__cover">' + books[key].image_url + '</div>';
        bookContent+= '<div class="book-view__title">' + books[key].title + '</div>';
        bookContent+= '<div class="book-view__author">' + books[key].author + '</div>';
        bookContent+= '<div class="book-view__rating">' + books[key].rating + '</div>';

    }
    libraryArea.innerHTML(bookBorder);
    aBookArea.innerHTML(bookContent);
}